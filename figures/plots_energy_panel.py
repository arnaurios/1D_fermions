...
for iy,A_num_part in enumerate(A) :
    ...
    if os.path.exists(fname_ML) :
        ...
        ee_ml=mlx[:,2]
        iplot=1
        ax[iy].fill_between(v_ml,e_ml-ee_ml,e_ml+ee_ml,color=linestyle_color[iplot],alpha=0.8,zorder=3)
        ax[iy].plot(v_ml,e_ml,linestyle_dashes[iplot],color=linestyle_color[iplot],label=line_label[iplot],zorder=linestyle_order[iplot],linewidth=linestyle_width[iplot])
    ...
    if A_num_part == 2 :
        ...
        if os.path.exists(fname_2d) :
            ...
            iplot=4
            ax[iy].plot(v_sp,e_sp,linestyle_dashes[iplot],color=linestyle_color[iplot],label=line_label[iplot],zorder=linestyle_order[iplot],linewidth=linestyle_width[iplot])
    ...
    if os.path.exists(fname_diag) :
        ...
        iplot=0
        ax[iy].plot(v_d,e_d,linestyle_dashes[iplot],color=linestyle_color[iplot],label=line_label[iplot],zorder=linestyle_order[iplot],linewidth=linestyle_width[iplot])
    ...
    if os.path.exists(fname_HF) :
        ...
        iplot=3
        ax[iy].plot(v_hf,e_hf,linestyle_dashes[iplot],color=linestyle_color[iplot],label=line_label[iplot],zorder=linestyle_order[iplot],linewidth=linestyle_width[iplot])
